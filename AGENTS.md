...
Comprehensive spell checking configuration is defined in `.vscode/cspell.json` with PowerShell-specific terms and flagged abbreviations.


## Git Ignore Patterns

Git ignore patterns follow PowerShell community standards (see `.gitignore`).
