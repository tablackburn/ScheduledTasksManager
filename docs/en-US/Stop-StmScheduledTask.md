...
```
Stop-StmScheduledTask [-TaskName] <String> [[-TaskPath] <String>] [[-ComputerName] <String>]
...
This function wraps the built-in Stop-ScheduledTask cmdlet to provide credential
...
### -TaskPath
Specifies the path of the scheduled task to stop.
...
### -ComputerName
Specifies the name of the computer on which to stop the scheduled task.
