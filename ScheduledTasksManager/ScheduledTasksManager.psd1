#
# Module manifest for module 'ScheduledTasksManager'
#
...
GUID = '158c4068-aff1-41e8-a5e8-160651ceadac'
...
Description = 'Manages local and clustered scheduled tasks in standalone or failover cluster environments, extending the ScheduledTasks module from Microsoft'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/tablackburn/ScheduledTasksManager'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/tablackburn/ScheduledTasksManager/blob/main/CHANGELOG.md'
